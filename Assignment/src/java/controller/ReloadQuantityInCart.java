 ...
 * @author DELL
 */
public class ReloadQuantityInCart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                id1 = Integer.parseInt(productId);
            } catch (Exception e) {
            }
            ...
            int totalprice = 0;
            if (quanAction == 1) { // == 1 thì giảm số lượng
                for (Cart cart : listCart) {
                    if (cart.getProductId() == id1) {
