        ...
        <div id="templatemo_wrapper">
            ...
            <div id="templatemo_menu">
                <div id="top_nav" class="ddsmoothmenu">
                    <ul>
                        ...
                        <li><a href="news" class="selected">Mách bạn</a></li>
            ...
            <div id="templatemo_main">
                ...
                <div id="content" class="float_r">
                    <h1> Mách bạn một số tips để luôn xinh đẹp</h1>
                    <div class="content-news">
                        <c:forEach items="${requestScope.news}" var="n">
                            <h4 style="color: #08aee3; font-weight: 600;">${n.getTitle()}</h4>
                            <pre style="font-size: 18px;font-family: initial; white-space: pre-line;">${n.getContent()}</pre>
                        </c:forEach>
                    </div>     
                </div>
                <div class="cleaner"></div>
