        ...
        <div id="templatemo_wrapper">
            ...
            <div id="templatemo_main">
                ...
                <div id="content" class="float_r">                   
                    <h2 style="color: #08aee3; font-weight: 500; text-decoration: underline">${detail.productName}</h2>                  
                    <div class="content_half float_l">                        
                        <img style="width: 300px; height: 250px" src="${detail.getImages()}"/>                       
                    </div>
                    <div class="content_half float_r">
                        <table>
                            <tr>
                                <td height="30" width="160">Giá sản phẩm:</td>                                
                                <td>${detail.getPrice()} VND</td>                               
                            </tr>
                            <tr>
                                <td height="30">Số lượng:</td>
                                <td>
                                    <select style="width: 35px; height: 30px; text-align: right">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                        ...
                        <a href="add-to-cart?productId=${detail.getProductId()}" class="add_to_card" style="color: #fff">Thêm giỏ hàng</a>
                    </div>
                    <div class="cleaner h30"></div>

                    <h3>Mô tả sản phẩm:</h3>                    
                    <p style="font-size: 16px">${detail.getDescription()}</p>
